export const NoFeatures = () => {
  return (
    <section className="flex w-full flex-col items-center justify-start p-8">
      ...
      <h3 className="mb-4">System Upgrades Incoming!</h3>
      <p className="mb-8">
        The feature sonar is quiet for now, but our crew is hard at work
        building exciting updates to propel your SubPort experience to new
        depths! Stay tuned for future enhancements.
      </p>
    </section>
  );
};
