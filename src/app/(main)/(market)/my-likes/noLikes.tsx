...
export const NoLikes = () => {
  return (
    <section className="flex w-full flex-col items-center justify-start p-8">
      ...
      <h3 className="mb-4">Like It, See More Of It!</h3>
      <p className="mb-8">
        This is where your favorite finds will live! Start liking items across
        SubPort to unlock better recommendations and discover unique products.
      </p>
