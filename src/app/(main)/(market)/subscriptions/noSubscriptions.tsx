...
export const NoSubscriptions = () => {
  return (
    <section className="flex w-full flex-col items-center justify-start p-8">
      ...
      <h3 className="mb-4">Subscribe & Shine!</h3>
      <p className="mb-8">
        Ready for a merch adventure? Follow your favorite creators to snag
        unique items and unlock personalized recommendations.
      </p>
