export const NoOrders = () => {
  return (
    <section className="mx-auto flex w-full max-w-[1200px] flex-col items-center justify-start p-8">
      ...
      <h3 className="mb-4">Your First Fan Awaits!</h3>
      <p className="mb-8 text-center">
        Welcome aboard, superstar! That first sale is a milestone – the start of
        something amazing.
        <br />
        We&apos;re cheering you on to make it happen. Go get &apos;em!
      </p>
    </section>
  );
};
