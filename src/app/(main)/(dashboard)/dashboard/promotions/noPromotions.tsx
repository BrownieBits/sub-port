...
export const NoPromotions = () => {
  return (
    <section className="flex w-full flex-col items-center justify-start p-8">
      ...
      <h3 className="mb-4">Ready to Make a Splash?</h3>
      <p className="mb-8">
        This is your platform to launch exciting deals! Promotions are a
        powerful way to drive interest, move products, and give your fans a
        great reason to submerge themselves in your store.
      </p>
