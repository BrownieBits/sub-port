import NewCollectionForm from './newCollectionButton';
...
export const NoCollections = () => {
  return (
    <section className="flex w-full flex-col items-center justify-start p-8">
      ...
      <h3 className="mb-4">No Collections Aboard Yet!</h3>
      <p className="mb-8">
        This is your command center for organizing your amazing merch! Grouping
        products into collections helps fans navigate your store and surface
        their next favorite find.
      </p>
      <NewCollectionForm />
    </section>
  );
