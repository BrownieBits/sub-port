  ...
  if (comments === null) {
    return (
      <section className="flex w-full flex-col gap-2">
        <Skeleton className="h-5 w-[150px] bg-layer-two" />
        ...
        <section className="flex w-full items-start gap-4">
          ...
          <section className="flex flex-1 flex-col gap-1">
            <Skeleton className="h-3 w-[200px] bg-layer-two" />
            <Skeleton className="h-3 w-full max-w-[500px] bg-layer-two" />
            <Skeleton className="h-3 w-full max-w-[400px] bg-layer-two" />
          </section>
        </section>
        <section className="flex w-full items-start gap-4">
          <Skeleton className="aspect-square w-[50px] rounded-full" />
